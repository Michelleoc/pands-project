...
* Shows the summary of each variable by the species  
...
The Iris Setosa petal leght and petal width attributes data do not overlap with the Veriscolor and Virginica.  
